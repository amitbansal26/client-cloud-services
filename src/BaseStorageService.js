...
class BaseStorageService {
  ...
  /**
   * @description                     - Upload file to storage service
   * @throws                          - Throws Exception if method is not invoked without declaration
   * @param {string} container        - Container name or folder name in storage service
   * @param {string} fileName         - File name of file to be uploaded
   * @param {string} filePath         - File path for file to be uploaded
   * @param {object} options          - Metadata options for file
   * @param { function } callback     - Callback function
   */
